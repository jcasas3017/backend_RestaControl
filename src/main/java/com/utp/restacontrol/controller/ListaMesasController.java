...
public class ListaMesasController {
        ...
        @GetMapping("/atenciones/{idAtencion}/pedido-actual")
        public ResponseEntity<?> pedidoActual(
                        @PathVariable UUID idAtencion) {
                var data = service.obtenerPedidoActual(idAtencion);
                return ResponseEntity.ok(Map.of(
                                "success", true,
                                "message", "Pedido actual obtenido",
                                "data", data));
        }
        ...
        public ResponseEntity<?> cancelarDetalle(
                ...
                var data = service.cancelarDetalle(idDetalle);
                return ResponseEntity.ok(Map.of(
                                "success", true,
